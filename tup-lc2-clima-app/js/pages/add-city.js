...
let agregarCiudad = '<p class="alerta agregarCiudad">Ciudad agregada con éxito</p>';
let errorNo = '<p class="alerta error">Error: La ciudad ingresada no se encuenta en la API o se produjo un error al consultar</p>';
let yaAlmacenada = '<p class="alerta yaAlmacenada" >La ciudad ingresada ya se encuentra almacenada</p>';
